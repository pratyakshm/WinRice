...
Function CleanWin {
	Clear-Host
	Write-Host " "
	Write-Host "CleanWin v0.3.7 by pratyakshm"
...
Function UnpinMicrosoftStore {
	Write-Host "Unpinning Microsoft Store from Taskbar..."
	$Signature = @{
		Namespace = "WinAPI"
		Name = "GetStr"
		Language = "CSharp"
...
"@
	...
	Write-Host "Unpinned Microsoft Store from Taskbar."
}
