...
# All rights reserved.
# Used to setup Windows Update for Windows Insiders

Write-Host "Applying recommended settings for Windows Update for Windows Insiders..."
...
Set-ItemProperty -Path $Update1 -Name DeferFeatureUpdatesPeriodInDays -Type DWord -Value 4
